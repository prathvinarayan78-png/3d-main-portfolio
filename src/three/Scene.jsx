...
function Ground() {
  return (
    <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.02, -70]} receiveShadow>
      ...
      <meshStandardMaterial color="#35502a" roughness={1} metalness={0} />
    </mesh>
  );
}
...
export default function Scene() {
  return (
    ...
    >
      ...
      <fogExp2 attach="fog" args={['#c6d8e4', 0.011]} />

      <Sky sunPosition={[28, 14, -80]} turbidity={7} rayleigh={1.4} mieCoefficient={0.006} />
      <ambientLight intensity={0.55} />
      <hemisphereLight args={['#bcd6ea', '#3d5a2b', 0.85]} />
      <directionalLight
        position={[26, 30, -14]}
        intensity={2.6}
        color="#ffe6bd"
      ...
      <Suspense fallback={null}>
        ...
        <Clouds material={THREE.MeshBasicMaterial} limit={60}>
          <Cloud seed={2} position={[-34, 34, -74]} speed={0.12} opacity={0.4} bounds={[18, 4, 12]} />
          <Cloud seed={7} position={[40, 40, -128]} speed={0.1} opacity={0.32} bounds={[22, 5, 14]} />
        </Clouds>
      </Suspense>
